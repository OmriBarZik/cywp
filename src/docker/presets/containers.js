  ...
  return docker.CreateContainer(
    {
      ...
      environmentVariables: [{ name: 'MYSQL_ROOT_PASSWORD', value: 'cywp' }],
      health: {
        command:
          "mysqladmin ping -u root -p$MYSQL_ROOT_PASSWORD | grep 'mysqld is alive'", // eslint-disable-line spellcheck/spell-checker
        startPeriod: '5s',
        retries: 30,
        interval: '1s'
      }
  ...
  return docker.CreateContainer(
    {
      ...
      environmentVariables: [
        {
          ...
          value: `${mysqlContainer.options.name}:3306`
        },
      ...
      volumes: [
        ...
        {
          host: `cywp-${name}-volume-themes`,
          docker: '/var/www/html/wp-content/themes'
        },
        {
          host: `cywp-${name}-volume-plugins`,
          docker: '/var/www/html/wp-content/plugins'
        }
      ].concat(volumes),
