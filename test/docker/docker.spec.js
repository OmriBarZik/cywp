  ...
  describe('#processCreateContainerOptions()', () => {
    describe('##Errors', () => {
      ...
      it('should throw error when image value is not present', () => {
        ...
        expect(() => {
          processCreateContainerOptions({ image: '' })
        }).toThrow()
      })
      ...
      it('should throw error when environmentVariables is not an array', () => {
        expect(() => {
          processCreateContainerOptions({
            image: 'test',
            environmentVariables: 'fail test'
          })
        }).toThrow()
      })
      ...
      it('should throw error when volumes is not made of a specific object array', () => {
        expect(() => {
          processCreateContainerOptions({ image: 'test', volumes: [{}] })
        }).toThrow()
      ...
      it('should throw error when environmentVariables is not made of a specific object array', () => {
        ...
        expect(() => {
          processCreateContainerOptions({
            image: 'test',
            environmentVariables: [{ name: 'docker' }]
          })
        }).toThrow()
        ...
        expect(() => {
          processCreateContainerOptions({
            image: 'test',
            environmentVariables: [{ value: 'host' }]
          })
        }).toThrow()
        ...
        expect(() => {
          processCreateContainerOptions({
            image: 'test',
            environmentVariables: [{ error: 'error' }]
          })
        }).toThrow()
      })
      ...
      it('should throw error when exposePorts is not made of a specific object array', () => {
        expect(() => {
          processCreateContainerOptions({ image: 'test', exposePorts: [{}] })
        }).toThrow()

        expect(() => {
          processCreateContainerOptions({
            image: 'test',
            exposePorts: [{ host: 'docker' }]
          })
        }).toThrow()
      ...
      it('should throw error when options.health.command is not defined', () => {
        expect(() =>
          processCreateContainerOptions({ image: 'test', health: {} })
        ).toThrow(
      ...
      it('should throw error when options.health.retries is not a number', () => {
        expect(() =>
          processCreateContainerOptions({
            image: 'test',
            health: { command: ['test'], retries: 1.2 }
          })
      ...
      it('should throw an error when commands is not array', () => {
        expect(() =>
          processCreateContainerOptions({ image: 'test', commands: 'first' })
        ).toThrow()
      })
    ...
    describe('##Returns', () => {
      it('should contains base args to create container', () => {
        ...
        const arr2 = processCreateContainerOptions(
          { image: 'image-test' },
          false,
          false
        )
      ...
      it('should contains base args to run container', () => {
        const arr1 = processCreateContainerOptions(
          { image: 'image-test' },
          true,
          false
        )
  ...
  describe('#CreateNetwork()', () => {
    ...
    it('should create docker network with object', async () => {
      const network = await docker.CreateNetwork({
        name: 'cywp-create-network-with-object-test'
      })
    ...
    it('should create docker network with string', async () => {
      const network = await docker.CreateNetwork(
        'cywp-create-network-with-string-test'
      )
      const networkCheck = spawnSync('docker', [
        'network',
        'ls',
