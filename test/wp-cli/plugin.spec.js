...
describe('Plugin', () => {
  ...
  describe('#activate()', () => {
    it('should have the arguments to activate plugin', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['activate', 'plugin'])
    })
    ...
    it('should have the arguments to activate all plugins', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['activate', '--all'])
    })
  })
  ...
  describe('#deactivate()', () => {
    it('should have the arguments to deactivate plugin', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['deactivate', 'plugin'])
    })
    ...
    it('should have the arguments to deactivate all plugins', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['deactivate', '--all'])
    })
    ...
    it('should have the arguments to deactivate and uninstall plugin', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['deactivate', '--uninstall', 'plugin'])
    })
  })
  ...
  describe('#delete()', () => {
    it('should have the arguments to delete plugin', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['delete', 'plugin'])
    })
    ...
    it('should have the arguments to delete multiple plugins', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['delete', 'plugin1', 'plugin2'])
    })
    ...
    it('should throw an error massage with plugin in it', () => {
      expect(() => plugin.delete(1)).toThrow(new TypeError('plugin must be an array or a string'))
    })
  })

  describe('#get()', () => {
    it('should have the arguments to get plugin info', () => {
      plugin.wpPlugin = jest.fn((commands) => Promise.resolve({ stdout: JSON.stringify(commands) }))

      plugin.get('plugin')

      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['get', '--format=json', 'plugin'])
    })
  })
  ...
  describe('#install()', () => {
    it('should have the arguments to install plugin', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['install', '--force', 'plugin'])
    })
    ...
    it('should have the arguments to install multiple plugins', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['install', '--force', 'plugin1', 'plugin2'])
    })
    ...
    it('should have the arguments to install and activate plugin', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['install', '--force', '--activate', 'plugin'])
    })

    it('should throw an error when trying to install an activate multiple plugins', () => {
      expect(() => plugin.install(['plugin1', 'plugin2'], true))
        .toThrow(new Error('To use activate there must be at only one plugin given.'))
    })
    ...
    it('should have the arguments to install different version plugin', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['install', '--force', '--version=2.2', 'plugin'])
    })

    it('should throw an error when trying to install an different version multiple plugins', () => {
      expect(() => plugin.install(['plugin1', 'plugin2'], false, '2.2'))
        .toThrow(new Error('To use version there must be at only one plugin given.'))
    })
  })
  ...
  describe('#isInstalled()', () => {
    it('should have args to check plugin installation', () => {
      ...
      expect(plugin.wpPlugin).toHaveBeenLastCalledWith(['is-installed', 'plugin'])
    })
  ...
  describe('#list()', () => {
    it('should throw error when filters is not object', () => {
      expect(() => plugin.list('test')).toThrow(new TypeError('filters must be an object'))
    })

    it('should have arguments for listing plugins', () => {
      plugin.wpPlugin = jest.fn(() => Promise.resolve({ stdout: JSON.stringify('data') }))
  ...
  describe('#path()', () => {
    ...
    it('should have arguments to get plugin directory', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['path', '--dir', 'plugin'])
    })
  })
  ...
  describe('#uninstall()', () => {
    it('should have arguments to uninstall plugin', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['delete', '--deactivate', 'plugin'])
    })
    ...
    it('should have arguments to uninstall multiple plugins', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['delete', '--deactivate', 'plugin1', 'plugin2'])
    })
    ...
    it('should have arguments to uninstall all plugins', () => {
      ...
      expect(plugin.wpPlugin)
        .toHaveBeenLastCalledWith(['delete', '--deactivate', '--all'])
    })
  })
})
